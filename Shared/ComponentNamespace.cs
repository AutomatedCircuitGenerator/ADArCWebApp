...
namespace ADArCWebApp.ComponentNamespace
{
	...
	public static class ComponentDeclarations
	{
		...
		{
            { 1, new ComponentDataBuilder("Uno Rev3", true, "Arduino", .33, 75, 75).Finish() },
            ...
            { 20, new ComponentDataBuilder("DHT11/DHT22 ", true, "Input/Temperature and Humidity Sensors", 1, 75, 75).Finish() },
            ...
            { 31, new ComponentDataBuilder("LED", true, "Output/LED", 1.5, 75, 75, false, RazorLED.update).Finish() },
            { 32, new ComponentDataBuilder("7-segment", true, "Output/LED", 1, 75, 75, paneHoverText: "Adafruit 0.56''").Finish() },
            ...
            { 41, new ComponentDataBuilder("LCD1602", true, "Output/Displays/LCD", .25, 75, 75, "").Finish() },
