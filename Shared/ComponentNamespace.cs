...
namespace ADArCWebApp.ComponentNamespace
{
	...
	public static class ComponentDeclarations
	{
		public static Dictionary<int, ComponentData> components = new()
		{
            ...
            { 7, new ComponentDataBuilder("MPU6050", true, "Input/Acceleration Sensors", 1.3, 75, 60).Finish() },
            { 8, new ComponentDataBuilder("BNO-055", true, "Input/Acceleration Sensors", 1, 110, 85).Finish() },
            ...
            { 28, new ComponentDataBuilder("IR receiver", true, "Input/Other Sensors", 1.3, 60, 80, paneHoverText: "KY-022").Finish() },
            { 29, new ComponentDataBuilder("SD Card Reader", false, "Input/Other Sensors", 1, 75, 75).Finish() },
            { 30, new ComponentDataBuilder("Load Cell(HX711)", true, "Input/Other Sensors", 0.6, 75, 75, paneHoverText: "TAL221").Finish() },
            ...
            { 36, new ComponentDataBuilder("RGB", true, "Output/LED", 1.5, 75, 75).Finish() },
            ...
            { 45, new ComponentDataBuilder("Direct - SG90", true, "Output/Motors/Servo Motor", 0.65, 75, 75).Finish() },
            ...
            { 53, new ComponentDataBuilder("Nema-17", true, "Output/Motors/Stepper Motor", 0.6, 75, 75, paneHoverText: "Includes driver").Finish() },
