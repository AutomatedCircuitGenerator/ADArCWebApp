...
namespace ADArCWebApp
{
    public static class GraphSynthInvoke
    {
        ...
        public static void Connect(string from, string to = "arduino")
        {
            ruleSet connect = rulesets["CONNECT"];
            ...
            {
                if (seed.nodes[i].localLabels.Contains(from) && !seed.nodes[i].localLabels.Any(l => l.Contains("localId:")))
                {
            ...
            foreach (var arc in rule.R.arcs)
            {
                ...
                var matchedToNode = toNodes.Find(n =>
        ...
        public static void removeComp(node n)
        {
            if (n == null)
            {
                return;
